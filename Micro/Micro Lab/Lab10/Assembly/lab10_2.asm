...
_IS_ASCII_B: 
	CJNE 	A,#'B',_IS_ASCII_0
	MOV 	A,#0BH
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_0: 
	CJNE 	A,#'0',_IS_ASCII_1
	MOV 	A,#00H
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_1: 
	CJNE 	A,#'1',_IS_ASCII_2
	MOV 	A,#01H
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_2: 
	CJNE 	A,#'2',_IS_ASCII_3
	MOV 	A,#02H
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_3: 
	CJNE 	A,#'3',_IS_ASCII_4
	MOV 	A,#03H
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_4: 
	CJNE 	A,#'4',_IS_ASCII_5
	MOV 	A,#04H
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_5: 
	CJNE 	A,#'5',_IS_ASCII_6
	MOV 	A,#05H
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_6: 
	CJNE 	A,#'6',_IS_ASCII_7
	MOV 	A,#06H
	CALL 	Display
	JMP 	Main_Loop

_IS_ASCII_7: 
	CJNE 	A,#'7',_IS_ASCII_8
	MOV 	A,#07H
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_8: 
	CJNE 	A,#'8',_IS_ASCII_9
	MOV 	A,#08H
	CALL 	Display
	JMP 	Main_Loop
	
_IS_ASCII_9: 
	CJNE 	A,#'9',_IS_ASCII_Etc
	MOV 	A,#09H
	CALL 	Display
	JMP 	Main_Loop
...
Seg_Tab: 
	DB 77H, 11H, 6DH, 5DH, 1BH, 5EH, 7EH, 15H
